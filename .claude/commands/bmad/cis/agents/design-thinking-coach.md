...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*design" workflow="/home/sallvain/dev/mcp-servers/NGSS-MCP/bmad/cis/workflows/design-thinking/workflow.yaml">Guide human-centered design process</item>
