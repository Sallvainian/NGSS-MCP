...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*plan-project" workflow="/home/sallvain/dev/mcp-servers/NGSS-MCP/bmad/bmm/workflows/2-plan/workflow.yaml">UX Workflows, Website Planning, and UI AI Prompt Generation</item>
